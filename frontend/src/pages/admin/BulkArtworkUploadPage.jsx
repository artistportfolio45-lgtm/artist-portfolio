...
const BulkArtworkUploadPage = () => {
  ...
  return <AdminLayout><div className="mx-auto max-w-6xl p-6 md:p-8">
    ...
    {items.length > 0 && <div className="mb-4 grid grid-cols-2 gap-3"><div className="border border-green-200 bg-green-50 p-3"><p className="text-xs font-label uppercase tracking-wider text-green-700">Ready to check</p><p className="mt-1 text-2xl text-charcoal">{uniqueSelectionCount}</p><p className="mt-1 text-xs text-slate/60">Existing Gallery duplicates are checked during upload.</p></div><div className="border border-amber-200 bg-amber-50 p-3"><p className="text-xs font-label uppercase tracking-wider text-amber-700">Duplicates in selection</p><p className="mt-1 text-2xl text-charcoal">{duplicateCount}</p></div></div>}
